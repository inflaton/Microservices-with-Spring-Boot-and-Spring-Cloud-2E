...
function recreateComposite() {
  ...
  echo creating ProductComposite $productId
  ...
  echo created ProductComposite $productId
}
...
then
  ...
  echo "$ $DOCKER_COMPOSE down --remove-orphans"
...
ACCESS_TOKEN=$(curl --request POST \
                 --url https://dev-c8-4oqyp.us.auth0.com/oauth/token \
                 --header 'content-type: application/json' \
                 --data '{"client_id":"Qb9D9g7fCdZtf086wvZSWq0qaRIZ2zGL","client_secret":"jgiYtC2ytEacjnACzL0mCQ6UW1xxXGwBpGA55yL5hyJJRt05R2yyOPw2pAHs60LF","audience":"https://localhost:8443/product-composite","grant_type":"client_credentials"}' \
                 -s | jq .access_token -r)
...
READER_ACCESS_TOKEN=$(curl --request POST \
                        --url https://dev-c8-4oqyp.us.auth0.com/oauth/token \
                        --header 'content-type: application/json' \
                        --data '{"client_id":"ISIlFcdxY91EIEbzYYpV796SVd71PZZu","client_secret":"nHZV60E884aV9ihqT0fJcfbrk9DL3AKPoDWrCK4C9oKdi3ZwY99lmAMBAnH9C87a","audience":"https://localhost:8443/product-composite","grant_type":"client_credentials"}' \
                        -s | jq .access_token -r)
